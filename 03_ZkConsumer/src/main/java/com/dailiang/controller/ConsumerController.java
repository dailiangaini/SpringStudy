...
public class ConsumerController {
    ...
    public String geConsumer() {
        ServiceInstance serviceInstance = loadBalancer.choose("zk-provider");
    ...
    public String geConsumer2() {
        List<ServiceInstance> instances = discoveryClient.getInstances("zk-provider");
    ...
    public List<String> getServiceUrl() {
        List<ServiceInstance> list = discoveryClient.getInstances("zk-provider");
