...
public class ConsumerController {
    ...
    public String geConsumer() {
        ...
        String memberUrl = "http://nacos-provider/geProvider";
    ...
    /**
     * loadBalancer使用的RestTemplate不能使用@LoadBalanced
     * @return
     */

    @RequestMapping("/geConsumer2")
    public String geConsumer2() {
        ServiceInstance serviceInstance = loadBalancer.choose("nacos-provider");
        // order 使用rpc 远程调用技术 调用
    ...
    /**
     * discoveryClient使用的RestTemplate不能使用@LoadBalanced
     * @return
     */
    ...
    public List<String> getServiceUrl() {
        List<ServiceInstance> list = discoveryClient.getInstances("nacos-provider");
